...
export default function Admin({ userName, jwt, role }) {
  ...
  return (
    <div style={{ height: "100%", width: "100%", display: "flex", background: "#f6f7f9", flexDirection: "column", alignItems: "center", justifyContent: "space-between" }}>
      ...
      <div style={{ height: "87%", margin: 0, width: "100%", overflow: "auto", display: "flex", background: "#ffffff", flexDirection: "column", alignItems: "center", justifyContent: "space-evenly" }}>
        {
          userArr.map((obj, idx) => {
...
function Box({ rank, totalPlayed, totalWon, percent, userName }) {
  return (
    <div style={{ height: "5rem", width: "50%", background: "#ffffff", borderRadius: "6px", boxShadow: "0 1px 3px rgba(0,0,0,0.12), 0 1px 2px rgba(0,0,0,0.24)", display: "flex", alignItems: "center", justifyContent: "center", justifyContent: "space-between" }}>
